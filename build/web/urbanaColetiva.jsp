<%-- 
    Document   : urbanaColetiva
    Created on : 19/11/2017, 19:50:01
    Author     : rwspa
--%>
...
<html>
    <head>
        ...
        <title>Teste Usucapiao Judicial Coletiva</title>
    </head>
    <body>
               <!--Menu-->
        <nav>
    ...
    <div class="container">
        <font face="tahoma">
            ...
            <form action="UsucapiaoJudicialUrbanoColetivoServlet" method="post" name="frmUsucapiaoJudicialUrbanoColetivo" onsubmit="return validaFormularioCadastro()">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>O imovel é urbano?</td><td><input type="checkbox" name="imovelUrbano"></td>
                    </tr>
                    <tr>
