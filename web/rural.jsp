<%-- 
    Document   : rural
    Created on : 19/11/2017, 19:36:14
    Author     : rwspa
--%>
...
<html>
    <head>
        ...
        <title>Teste Usucapiao Judicial Rural</title>
    </head>
    <body>
               <!--Menu-->
        <nav>
    ...
    <div class="container">
        <font face="tahoma">
            ...
            <form action="UsucapiaoJudicialRuralServlet" method="post" name="frmUsucapiaoJudicialRural" onsubmit="return validaFormularioCadastro()">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>Você ou sua familia rezide no imovel?</td><td><input type="checkbox" name="pessoalidade"></td>
                    </tr>
                    <tr>
                        <td>Possui area produtiva? (pode ser para proprio consumo)</td><td><input type="checkbox" name="areaProdutiva"></td>
                    </tr>
                    <tr>
                        <td>Possui outro imovel em seu nome?</td><td><input type="checkbox" name="registroDeOutroImovel"></td>
                    </tr>
                    <tr>
                        <td>O imovel é rural?</td><td><input type="checkbox" name="imovelRural"></td>
                    </tr>
                    <tr>
                        <td>Possui outro imovel em seu nome?</td><td><input type="checkbox" name="registroDeOutroImovel"></td>
                    </tr>
