<%-- 
    Document   : urbana
    Created on : 19/11/2017, 19:42:27
    Author     : rwspa
--%>
...
<html>
    <head>
        ...
        <title>Teste Usucapiao Judicial Urbana</title>
    </head>
    <body>
               <!--Menu-->
        <nav>
    ...
    <div class="container">
        <font face="tahoma">
            ...
            <form action="UsucapiaoJudicialUrbanoServlet" method="post" name="frmUsucapiaoJudicialUrbano" onsubmit="return validaFormularioCadastro()">
                <table>
                    <tr>
